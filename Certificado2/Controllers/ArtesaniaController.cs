...
namespace Certificado2.Controllers
{
    public class ArtesaniaController : Controller
    {
        ...
        private async Task<FileStreamResult> CreatePdf(VArtesania artesania)
        {
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                ...
                using (PdfDocument pdfDocument = new PdfDocument(pw))
                {
                    ...
                    string fechaCreacion = artesania.FechaCreacion.ToString("dd/MM/yyyy");
                    ...
                    Paragraph valordescripcion = new Paragraph(artesania.Descripcion).AddStyle(negrita12);
        ...
        [HttpGet]
        public async Task<FileStreamResult> Create2(string Serie, int Folio)
